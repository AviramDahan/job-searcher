const DEFAULT_JSONBLOB_ENDPOINT = "https://jsonblob.com/api/jsonBlob/019fc867-6804-72eb-9e23-078e5bd539c0";
...
export async function handleSyncAction(params, env = process.env) {
  ...
  const eventId = clean(params.event_id, 220) || `${action}:${jobKey}:${nowString()}`;
